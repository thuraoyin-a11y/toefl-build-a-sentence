  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        <p className="text-apple-text-secondary">Loading practice...</p>
      </div>
    </div>
  );
}
...
export default async function PracticePage({ params }: PracticePageProps) {
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <PracticePageClient practiceSet={data.practiceSet as import("@/lib/types").PracticeSet} questions={data.questions} />
    </Suspense>
  );
}
